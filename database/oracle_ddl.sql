...
-- ---------------------------------------------------------
-- Secuencias y triggers para Oracle 11g/compatibles
-- ---------------------------------------------------------
...
CREATE OR REPLACE TRIGGER trg_departamento_bi
BEFORE INSERT ON departamento
FOR EACH ROW
BEGIN
  IF :NEW.id_dep IS NULL THEN
    :NEW.id_dep := seq_departamento.NEXTVAL;
  END IF;
END;
/
...
BEGIN
  IF :NEW.id_ubi IS NULL THEN
    :NEW.id_ubi := seq_ubicacion.NEXTVAL;
  END IF;
END;
/
...
BEGIN
  IF :NEW.id_cat IS NULL THEN
    :NEW.id_cat := seq_categoria.NEXTVAL;
  END IF;
END;
/
...
BEGIN
  IF :NEW.id_usr IS NULL THEN
    :NEW.id_usr := seq_usuario.NEXTVAL;
  END IF;
END;
/

CREATE OR REPLACE TRIGGER trg_articulo_bi
BEFORE INSERT ON articulo
FOR EACH ROW
BEGIN
  IF :NEW.id_art IS NULL THEN
    :NEW.id_art := seq_articulo.NEXTVAL;
  END IF;
END;
/

CREATE OR REPLACE TRIGGER trg_prestamo_bi
BEFORE INSERT ON prestamo
FOR EACH ROW
BEGIN
  IF :NEW.id_pres IS NULL THEN
    :NEW.id_pres := seq_prestamo.NEXTVAL;
  END IF;
END;
/
...
BEGIN
  IF :NEW.id_mov IS NULL THEN
    :NEW.id_mov := seq_movimiento.NEXTVAL;
  END IF;
END;
/

CREATE OR REPLACE TRIGGER trg_mantenimiento_bi
BEFORE INSERT ON mantenimiento
FOR EACH ROW
BEGIN
  IF :NEW.id_man IS NULL THEN
    :NEW.id_man := seq_mantenimiento.NEXTVAL;
  END IF;
END;
/
...
BEGIN
  IF :NEW.id_not IS NULL THEN
    :NEW.id_not := seq_notificacion.NEXTVAL;
  END IF;
END;
/
...
BEGIN
  IF :NEW.id_aud IS NULL THEN
    :NEW.id_aud := seq_auditoria.NEXTVAL;
  END IF;
END;
/
